...
public class RobotMap {
    ...
    public static Servo vacuumVacuumForkValveServo;
    public static Servo vacuumVacuumFrontValveServo;
    ...
    public static int kGripperMotorPowerChannel = 3;
    ...
    public static void init() {
        ...
        elevatorElevatorEncoder.setDistancePerPulse(0.02429);
        ...
        gripperGripperEncoder.setDistancePerPulse(0.04858);
        ...
        vacuumVacuumForkValveServo = new Servo(4);
        LiveWindow.addActuator("Vacuum", "VacuumForkValveServo", vacuumVacuumForkValveServo);
        
        vacuumVacuumFrontValveServo = new Servo(5);
        LiveWindow.addActuator("Vacuum", "VacuumFrontValveServo", vacuumVacuumFrontValveServo);
